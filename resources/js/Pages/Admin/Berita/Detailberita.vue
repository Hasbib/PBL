                    ...
                    <div class="card-body">
                        ...
                        <div class="">
                            <div class="col-md-6"  style="margin-bottom: 10px;">
                                ...
                                <div style="margin-bottom: 20px;">Profil Ketua Emailkomp Periode 2024</div>
                            </div>
                            <div class="">
                                <label style="margin-bottom: 5px; color: black;"><b>Deskripsi Awal</b></label>
                                <div style="margin-bottom: 20px;">Emailkomp adalah sebuah organisasi dibawah pengawasan langsung oleh Prodi Teknik Informatika</div>
                            </div>
                            <div class="">
                            ...
                            <div class="col-md-6"  style="margin-bottom: 10px;">
                                <label style="margin-bottom: 5px; color: black;"><b>Tanggal Upload</b></label>
